"update.maboost" <-
  function(object,x,y,test.x,test.y=NULL, n.iter,...){
    ...
    if(multiclass){
      result =maboost.machine.multi(x,ny,test.x,test.y,iter,maxmargin,smooth,smoothfactor,nu,bag.frac,random.feature,random.cost,lossObj,oldObj=NULL,na.action=na.action,...)
      ...
      result =maboost.machine.bin(x,ny,test.x,test.y,iter,maxmargin,smooth,smoothfactor,nu,bag.frac,random.feature,random.cost,lossObj,oldObj=NULL,na.action=na.action,...)
