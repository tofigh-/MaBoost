"maboost.machine.multi" <-
  function(x,y,test.x,test.y,iter=50,maxmargin=FALSE,smooth=FALSE,smoothfactor=1,sparse=FALSE,nu=0.1,bag.frac=0.5,random.feature=TRUE,random.cost=TRUE,lossObj,oldObj=NULL,na.action=na.action,...){
